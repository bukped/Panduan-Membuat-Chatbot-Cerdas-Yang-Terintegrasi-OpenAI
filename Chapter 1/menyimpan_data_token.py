...
# Kedua, variabel "TokenDiscord" ditentukan dengan mengambil nilai dari environment variable "DISCORD". Variabel ini akan digunakan sebagai token Discord untuk mengidentifikasi aplikasi ketika terhubung dengan server Discord.
